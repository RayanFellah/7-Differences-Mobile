...
@Component({
  selector: 'app-limited-waiting-page',
  templateUrl: './limited-waiting-page.component.html',
  styleUrls: ['./limited-waiting-page.component.scss']
})
export class LimitedWaitingPageComponent implements OnInit {
  ...
  startGame(): void {
    if (this.player2Name && this.player1Name) {
      this.socketService.emit('startGameLimite', { });
